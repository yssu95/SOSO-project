...
=======
	<div class="container">
		...
		<div class="slide1">
			<div class="row">
				<div class="col-xs-12">
					<div id="carouselSlide1" class="carousel slide"
						data-ride="carousel">
						<ol class="carousel-indicators">
							<li data-target="#carouselSlide1" data-slide-to="0"
								class="active"></li>
							<li data-target="#carouselSlide1" data-slide-to="1"></li>
...
=======
						<div class="carousel-inner" role="listbox">
							<div class="item active">
								<img src="/resources/images/main/mainslide/mainSlide1.jpg"
									alt="슬라이드1">
							</div>
							<div class="item">
								<img src="/resources/images/main/mainslide/mainSlide2.jpg"
							...
							<div class="item">
								<img src="/resources/images/main/mainslide/mainSlide3.jpg"
									alt="슬라이드3">
							</div>
						</div>
						<a class="left carousel-control" href="#carouselSlide1"
							role="button" data-slide="prev"> <span
							class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
						</a> <a class="right carousel-control" href="#carouselSlide1"
...
=======
		...
		<div class="slide2">
			<div class="row">
				<div class="col-sm-12 btnSlide2">
					...
					<button class="btn btn-sm" id="btnSlide2-4">
						<span class="glyphicon glyphicon-pause"></span>
					</button>
				</div>
			</div>
			<div class="row">
				<div id="carouselSlide2" class="carousel slide" data-ride="carousel">
					<div class="carousel-inner" role="listbox">
						<ul class="item active col-xs-6 col-sm-3">
							<li><a href="/shop/view?n=102"><img
									src="/resources/images/main/hall/hall2.jpg" alt="웨딩홀1"></a>
								<p>상록아트홀</p>
								<h4>가격: 11,300,000원</h4></li>
							<li><a href="/shop/view?n=100"><img
									src="/resources/images/main/hall/hall4.jpg" alt="웨딩홀2"></a>
								<p>노블발렌티청담</p>
								<h4>가격: 25,100,000원</h4></li>
							<li><a href="/shop/view?n=99"><img
									src="/resources/images/main/hall/hall3.jpg" alt="웨딩홀3"></a>
								<p>소노펠리체컨벤션</p>
								<h4>가격: 14,300,000원</h4></li>
							<li><a href="/shop/view?n=97"><img
									src="/resources/images/main/hall/hall1.png" alt="웨딩홀4"></a>
								<p>상록아트홀</p>
								<h4>가격: 11,300,000원</h4></li>
						</ul>
						<ul class="item col-xs-6 col-sm-3">
							<li><a href="/shop/view?n=106"><img
									src="/resources/images/main/dress/dress4.jpg" alt="드레스1"></a>
								<p class="card-text">엘리강스드레스</p>
								<h4>가격: 1,300,000원</h4></li>
							<li><a href="/shop/view?n=105"><img
									src="/resources/images/main/dress/dress3.jpg" alt="드레스2"></a>
								<p>홀드레스</p>
								<h4>가격: 900,000원</h4></li>
							<li><a href="/shop/view?n=104"><img
									src="/resources/images/main/dress/dress2.jpg" alt="드레스3"></a>
								<p>모네드레스</p>
								<h4>가격: 650,000</h4></li>
							<li><a href="/shop/view?n=103"><img
									src="/resources/images/main/dress/dress1.jpg" alt="드레스4"></a>
								<p>홀터넥드레스</p>
								<h4>가격: 550,000원</h4></li>
						</ul>
						<ul class="item col-xs-6 col-sm-3">
							<li><a href="/shop/view?n=113"><img
									src="/resources/images/main/hair/hair1.jpg" alt="헤어/메이크업1"></a>
									<p>단정헤어메이크업</p>
								<h4>가격: 250,000원</h4></li>
							

							<li><a href="/shop/view?n=110"><img
									src="/resources/images/main/hair/hair2.jpg" alt="헤어/메이크업3"></a>
									<p>코랄메이크업헤어</p>
								<h4>가격: 250,000원</h4></li>
							<li><a href="/shop/view?n=111"><img
									src="/resources/images/main/hair/hair6.png" alt="헤어/메이크업2"></a>
								<p>발랄오렌지ST</p>
								<h4>가격: 700,000원</h4></li>
							<li><a href="/shop/view?n=109"><img
									src="/resources/images/main/hair/hair3.jpg" alt="헤어/메이크업4"></a>
								<p>러블리즈메이크업</p>
								<h4>가격: 300,000원</h4></li>
						</ul>
					</div>
		...
		<div class="thumb">
			<div class="row">
				<div class="col-xs-4 col-md-2 boxThumb">
					<a href="/shop/list?c=104&l=2"><img
						src="/resources/images/main/sumnail/studio.jpg" alt="스튜디오"
						class="img-responsive img-circle"></a>
					<p>스튜디오</p>
				</div>
				<div class="col-xs-4 col-md-2 boxThumb">
					<a href="/shop/list?c=105&l=2"><img
						src="/resources/images/main/sumnail/snapNdvd.png" alt="스냅/DVD"
						class="img-responsive img-circle"></a>
					<p>스냅/DVD</p>
				</div>
				<div class="col-xs-4 col-md-2 boxThumb">
					<a href="/shop/list?c=106&l=2"><img
						src="/resources/images/main/sumnail/dressSuit.jpg" alt="예복"
						class="img-responsive img-circle"></a>
					<p>예복</p>
				</div>
				<div class="col-xs-4 col-md-2 boxThumb">
					<a href="/shop/list?c=107&l=2"><img
						src="/resources/images/main/sumnail/hanbok.jpg" alt="한복"
						class="img-responsive img-circle"></a>
					<p>한복</p>
				</div>
				<div class="col-xs-4 col-md-2 boxThumb">
					<a href="/shop/list?c=108&l=2"><img
						src="/resources/images/main/sumnail/bouquet.jpg" alt="부케"
						class="img-responsive img-circle"></a>
					<p>부케</p>
				</div>
				<div class="col-xs-4 col-md-2 boxThumb">
					<a href="/shop/list?c=109&l=2"><img
						src="/resources/images/main/sumnail/invitation.jpg" alt="청첩장"
						class="img-responsive img-circle"></a>
					<p>청첩장</p>
				</div>
			</div>
					...
					<table class="table">
						<c:forEach var="orderList" items="${orderList}" end="10">
							<tr>
								...
								<td>${orderList.orderRec}님 신청 접수 되었습니다.</td>
								<td><fmt:formatDate value="${orderList.orderDate}"
										pattern="yyyy-MM-dd" /></td>
							</tr>
						</c:forEach>
					...
					<table class="table table-hover">
						<c:forEach var="homelist" items="${homelist}" end="10">
							<tr>
								...
								<td>${homelist.writer}님의소중한 후기입니다. [${homelist.reply_cnt}]</td>
								<td><fmt:formatDate value="${homelist.regdate}"
										pattern="yyyy-MM-dd" /></td>
							</tr>
						</c:forEach>
