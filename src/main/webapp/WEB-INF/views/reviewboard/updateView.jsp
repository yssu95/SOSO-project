...
<link rel="stylesheet" href="/resources/css/main/header-footer.css">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".cancel_btn").on("click", function(){
				...
				location.href = "/reviewboard/readView?bno=${update.bno}"
					   + "&page=${scri.page}"
			...
			$(".update_btn").on("click", function(){
				...
				formObj.attr("action", "/reviewboard/update");
	...
	<div class="boardwrap">
		<div class="boardwrap2">
			<h2 id="h2">후기</h2>
			<p>소소웨딩 고객님들의 소중한 후기입니다</p>
		</div>
		<div class="boardwrap3">
				<form name="updateForm" role="form" method="post" action="/reviewboard/update" enctype="multipart/form-data">
			...
			<section id="container">
				<form name="updateForm" role="form" method="post" action="/reviewboard/update" enctype="multipart/form-data">
					...
					<table>
						...
						<tr>
								<td>
									<label for="header">말머리</label><input type="text" id="header" name="header" value="${update.header}" class="chk" title="말머리선택." readonly="readonly"/>
								</td>
							</tr>	
							<tr>
								<td>
