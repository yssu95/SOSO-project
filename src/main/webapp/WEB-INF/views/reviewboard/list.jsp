        ...
        <script>
         $(function(){
            $('#searchBtn').click(function() {
               self.location = "list" + '${pageMaker.makeQuery(1)}' + "&searchType=" + $("select option:selected").val() + "&keyword=" + encodeURIComponent($('#txtKeyWord').val());
            });
         });   
     </script>
      </div>
      <div id='write-btn'>
        <a href="/reviewboard/writeView">
        <input type='button' class="text_w" value='글쓰기' />
        </a>
      </div>
    </div>
    <ul>
               ...
               <!-- 주석 -->
                  <c:forEach items="${list}" var = "list">
                     <tr>
                        ...
                        <td>
                           <a href="/reviewboard/readView?bno=${list.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}">
