               ...
               <!-- 주석 -->
                  <c:forEach items="${list}" var = "list">
                     <tr>
                        ...
                        <td>
                           <a href="/qnaboard/readView?bno=${list.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}">
