...
public class ReviewBoardController {
   ...
   public String write(ReviewBoardVO boardVO, MultipartHttpServletRequest mpRequest) throws Exception {
      logger.info("write");
   ...
   public String read(ReviewBoardVO boardVO, HttpSession session, @ModelAttribute("scri") SearchCriteria scri, Model model, int bno) throws Exception {
      ...
      ReviewBoardVO bv = service.read(boardVO.getBno());
      model.addAttribute("review_board", bv);
      model.addAttribute("read", bv);
      model.addAttribute("scri", scri);
      service.boardhit(bno);

      List<ReviewReplyVO> replyList = replyService.readReply(boardVO.getBno());
      model.addAttribute("replyList", replyList);

      List<Map<String, Object>> fileList = service.selectFileList(boardVO.getBno());
      model.addAttribute("file", fileList);
      return "reviewboard/readView";
   }

   // 게시판 수정뷰
   @RequestMapping(value = "/updateView", method = RequestMethod.GET)
   public String updateView(ReviewBoardVO boardVO, @ModelAttribute("scri") SearchCriteria scri, Model model)
         throws Exception {
      ...
      List<Map<String, Object>> fileList = service.selectFileList(boardVO.getBno());
      model.addAttribute("file", fileList);
      return "reviewboard/updateView";
   }

   // 게시판 수정
   @RequestMapping(value = "/update", method = RequestMethod.POST)
   public String update(ReviewBoardVO boardVO, @ModelAttribute("scri") SearchCriteria scri, RedirectAttributes rttr,
   ...
   public String delete(ReviewBoardVO boardVO, @ModelAttribute("scri") SearchCriteria scri, RedirectAttributes rttr)
         throws Exception {
      logger.info("delete");
   ...
   public String replyWrite(ReviewReplyVO vo, SearchCriteria scri, RedirectAttributes rttr) throws Exception {
      ...
      return "redirect:/reviewboard/readView";
   }
   ...
   public String replyUpdateView(ReviewReplyVO vo, SearchCriteria scri, Model model) throws Exception {
      ...
      return "reviewboard/replyUpdateView";
   }
   ...
   public String replyDeleteView(ReviewReplyVO vo, SearchCriteria scri, Model model) throws Exception {
      ...
      return "reviewboard/replyDeleteView";
   }
