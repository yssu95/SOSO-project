...
public class QnaFileUtils {
	...
	public static List<Map<String, Object>> parseInsertFileInfo(QnaBoardVO boardVO, 
	...
	public static List<Map<String, Object>> parseUpdateFileInfo(QnaBoardVO boardVO, String[] files, String[] fileNames, MultipartHttpServletRequest mpRequest) throws Exception{ 
		Iterator<String> iterator = mpRequest.getFileNames();
		MultipartFile multipartFile = null; 
		String originalFileName = null; 
		String originalFileExtension = null; 
